...
public class RequestQuoteiPad3rd7 {
	...
	@Test
		...
		for(int row=1; row <=s.getRows();row++) {
			try {
				...
				FileUtils.copyFile(screenshot, new File("RequestQuoteiPad3rd7" +   "/" + row +  "-" + timeStamp + "-" + "success.png"));
		    	...
		    	FileUtils.copyFile(screenshotfailed, new File("RequestQuoteiPad3rd7Failed" +   "/" + count + timeStamp + "-" + "failed.png"));
		        //e.printStackTrace();
